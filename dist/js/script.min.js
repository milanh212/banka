...
gsap.timeline({scrollTrigger:{trigger:".benefits",start:"top center",end:"bottom bottom",markers:!1,scrub:!1,pin:!1,duration:10,stagger:2}}).fromTo(".benefits h2",{opacity:0,x:10},{opacity:1,x:0,duration:.2}).fromTo(".intro__txt",{opacity:0,x:-10},{opacity:1,x:0,duration:.2}).fromTo(".benefits__grid-item-img",{opacity:0,scale:.4},{opacity:1,scale:1}).fromTo(".benefits__grid-item h4",{opacity:0,y:20},{opacity:1,y:0}).fromTo(".benefits__grid-item p",{opacity:0,y:20},{opacity:1,y:0}),gsap.timeline({scrollTrigger:{trigger:".video",start:"top center",end:"bottom bottom",markers:!1,scrub:!1,pin:!1,duration:.2}}).fromTo(".video",{opacity:0},{opacity:1,duration:.3}).fromTo(".video__left video",{opacity:0,scale:.4},{opacity:1,scale:1}).fromTo(".video__right h2",{opacity:0,x:30},{opacity:1,x:0}).fromTo(".video__right p",{opacity:0,y:50},{opacity:1,y:0}).fromTo(".video__right a",{opacity:0,x:-10},{opacity:1,x:0}),gsap.timeline({scrollTrigger:{trigger:".ebank",start:"top center",end:"bottom bottom",markers:!1,scrub:!1,pin:!1,duration:.2}}).fromTo(".ebank__right",{opacity:0},{opacity:1}).fromTo(".ebank__left h2",{opacity:0,x:-30},{opacity:1,x:0}).fromTo(".ebank__left p",{opacity:0,y:-50},{opacity:1,y:0}).fromTo(".ebank__left a",{opacity:0,x:10},{opacity:1,x:0}),gsap.timeline({scrollTrigger:{trigger:".magazin",start:"top center",end:"bottom bottom",markers:!1,scrub:!1,pin:!1}}).fromTo(".magazin h2",{opacity:0,x:-30},{opacity:1,x:0,duration:.2}).fromTo(".magazin span",{opacity:0,x:10},{opacity:1,x:0,duration:.2}).fromTo(".magazin__grid-img",{opacity:0,x:10},{opacity:1,x:0,duration:.2}).fromTo(".magazin h3",{opacity:0,x:10},{opacity:1,x:0,duration:.2}).fromTo(".magazin p",{opacity:0,x:10},{opacity:1,x:0,duration:.2}).fromTo(".magazin a",{opacity:0,x:-10},{opacity:1,x:0,duration:.2}),gsap.timeline({scrollTrigger:{trigger:".form",start:"top center",end:"bottom bottom",markers:!1,scrub:!1,pin:!1}}).fromTo(".form",{opacity:0,y:50},{opacity:1,y:0,duration:.4}),gsap.timeline({scrollTrigger:{trigger:".tabela",start:"top center",end:"bottom bottom",markers:!1,scrub:!1,pin:!1}}).fromTo(".tabela",{opacity:0,y:50},{opacity:1,y:0,duration:.4}),gsap.timeline({scrollTrigger:{trigger:"footer",start:"top center",end:"bottom bottom",markers:!1,scrub:!1,pin:!1}}).fromTo("footer",{opacity:0},{opacity:1,duration:.4});
$(".cover .owl-carousel").owlCarousel({center:!1,stagePadding:0,items:1,loop:!0,margin:0,nav:!0,navSpeed:800,dots:!1,slideSpeed:900,paginationSpeed:900,slideBy:1,autoplay:!1,autoplayHoverPause:!1,autoplaySpeed:800,autoplayTimeout:3e3,responsive:{0:{nav:!1,dots:!1},1200:{nav:!0,dots:!0}}}),$(".ebank__right .owl-carousel").owlCarousel({center:!0,stagePadding:0,items:1,loop:!0,margin:50,nav:!0,navSpeed:800,dots:!1,slideSpeed:900,paginationSpeed:900,slideBy:1,autoplay:!0,autoplayHoverPause:!1,autoplaySpeed:800,autoplayTimeout:3e3,responsive:{0:{nav:!0,dots:!0},1200:{nav:!0,dots:!0}}}),$(".header__menu-btn").on("click",function(){return $(".header").toggleClass("main-menu__open"),$("main").toggleClass("hide"),$("footer").toggleClass("hide"),!1}),$(".has-child a").click(function(e){$(this).closest(".has-child").toggleClass("show-dropdown"),e.preventDefault()}),$(".benefits__grid-item-show").on("click",function(){return $(this).closest(".benefits__grid-item").toggleClass("benefits__open"),!1}),$("#email").keyup(function(){var e=$(this).val().length;if(e>=50)$("#charNum").text(" Uneli ste maksimalan broj karaktera");else{$("#charNum").text(e+" / 50")}}),$("#message").keyup(function(){var e=$(this).val().length;if(e>=350)$("#charNumM").text(" Uneli ste maksimalan broj karaktera");else{$("#charNumM").text(e+" / 350")}}),$(".tab h4").on("click",function(){return $(this).closest(".tab").toggleClass("tab__open"),!1}),$(".tab .close").on("click",function(){return $(this).closest(".tab").removeClass("tab__open"),!1});